...
const SettingsFrame = () => {
  const SettingsHead = () => {
    return (
      <div>
        <li>
          <Link to="/mainmenu/settings/profile">Profil</Link>
        </li>
        <li>
          <Link to="/mainmenu/settings/passwordchange">Ändra Lösenord</Link>
        </li>
        <li>
          <Link to="/mainmenu/settings/preferences">Preferenser</Link>
        </li>
